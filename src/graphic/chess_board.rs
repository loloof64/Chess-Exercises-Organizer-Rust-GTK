...
impl ChessBoard {
    ...
    fn draw_coordinates(context: &Context, cells_size: i32) {
        ChessBoard::configure_coordinates_drawing(context, cells_size);
        ChessBoard::paint_files_coordinates(context, cells_size);
        ChessBoard::paint_ranks_coordinates(context, cells_size);        
    }
